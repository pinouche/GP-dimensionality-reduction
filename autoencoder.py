...
def nn_autoencoder(seed, input_size, latent_size):
    ...
    model = keras.models.Sequential([
        ...
        # latent_layer
        keras.layers.Dense(latent_size, activation=keras.activations.linear, use_bias=True,
                           trainable=True, kernel_initializer=initializer),
        ...
        keras.layers.Dense(input_size, activation="elu", use_bias=False,
                           trainable=True, kernel_initializer=initializer),
    ...
    adam = keras.optimizers.Adam(lr=0.005, beta_1=0.9, beta_2=0.999, amsgrad=False)
